...
export default {
    ...
    methods: {
        ...
        resizeVideoDimension(height, width) {
            if (height > 1280) {
                this.videoMetaData.height = 1280
                this.videoMetaData.width = (1280/height * width).toFixed(0) // float to int
            } else if (width > 720) {
                this.videoMetaData.width = 720
                this.videoMetaData.height = (720/width * height).toFixed(0) // float to int
            } else {
                this.videoMetaData.width = width
                this.videoMetaData.height = height
            } console.log(this.videoMetaData.width, this.videoMetaData.height)
        },
        stopVideo() {
